    ...
    <section class="serviceSection pt-4 mt-4 pb-5">
        <div class="custom-container">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <p class="text-center mx-700">At Rehab My Sole, we see more than just shoes—we see cherished memories
                        and life’s journeys captured in every step. Our passion began with a simple belief: that every
                        well-worn pair deserves a second chance. We’re here to revive your footwear’s past while paving the
                        way for future adventures.</p>
                </div>
            </div>
        </div>
    </section>
    <section class="aboutMission pt-5 pb-5">
        <div class="custom-container">
            <div class="mainTitle text-center m-auto pb-0">
                <h3>Our Story</h3>
                <p class="m-auto pb-3">From the familiar scuffs on your favorite sneakers to the worn elegance of timeless
                    boots, we understand that shoes are not merely an accessory—they’re a part of your life’s narrative.
                    Founded on the principles of sustainability, simplicity, and genuine care, Rehab My Sole was born out of
                    the desire to preserve memories and reduce waste.</p>
                <p class="m-auto">Every repair, every custom design, and every restoration we perform is a labor of love—a
                    commitment to extending the life of your most treasured footwear. Our team of skilled artisans treats
                    each pair as a unique canvas, blending modern techniques with traditional craftsmanship to honor the
                    legacy of your shoes.</p>
            </div>
        </div>
    </section>
    <section class="aboutMission pt-5 pb-5">
        <div class="custom-container">
            <div class="mainTitle text-center m-auto pb-5">
                <h3>Who We Are</h3>
                <p class="m-auto pb-3">We’re a dedicated team of cobblers, designers, and shoe care specialists who believe
                    in a more mindful approach to footwear. Our work is driven by a passion for quality, sustainability, and
                    the simple truth that every shoe tells its own story. With every service, we strive to deliver an
                    experience that’s as personalized as it is transformative—ensuring your shoes not only look revived but
                    feel ready for their next chapter.</p>
                <h3>Our Mission</h3>
                <p class="m-auto pb-3">To give every pair of shoes a renewed life—preserving memories, reducing waste, and
                    empowering you to continue your journey with confidence and style.</p>
                ...
                <h3>Our Vision</h3>
                <p class="pb-3 m-auto">We envision a future where every step is a celebration of the stories we share—where
                    quality, sustainability, and heartfelt craftsmanship ensure that no memory is ever lost to time.</p>
                ...
                <p class="m-auto text-center">Join us in our journey to honor the past and stride confidently into the
                    future—one step, one story, one sole at a time.</p>
            </div>
        </div>
    </section>
    <section class="aboutMeet pt-4">
        <div class="custom-container">
            ...
            <div class="meetBlock">
                ...
                <div class="meetBlock-item">
                    <div class="meetFigure">
                        <img src="{{ asset('assets/media/profle.png') }}" width="" height=""
                            class="img-fluid" alt="Profile" />
                        <h4>First and Last Name</h4>
                        <span>Position Held</span>
                    </div>
